...
var app = (function () {
    ...
    /* src/components/atoms/PillButton.svelte generated by Svelte v3.16.0 */

    const file = "src/components/atoms/PillButton.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*title*/ ctx[0]);
    			attr_dev(button, "class", "bg-purple-700 w-full hover:bg-yellow-600 text-white font-normal capitalize py-2 px-4 rounded-full");
    			add_location(button, file, 3, 0, 45);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<PillButton> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const pillbutton = new PillButton({
    			props: { title: "Banana" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "bg-gray-300 font-bold");
    			add_location(div, file$1, 6, 1, 112);
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file$1, 9, 1, 173);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$1, 10, 14, 210);
    			add_location(p, file$1, 10, 1, 197);
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(p, t8);
    			append_dev(main, t9);
    			mount_component(pillbutton, main, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
